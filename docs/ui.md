...
- **[CLAUDE.md](../CLAUDE.md)** - High-level architecture and side panel UI overview
- **[docs/chrome_api.md](chrome_api.md)** - Chat interface implementation details
- **[docs/pglite.md](pglite.md)** - Search results data structure
